                    ...
                    <form method="POST" action="{{ url('review/update-review/'.$review->id) }}" enctype="multipart/form-data">
                        ...
                        <div id="step-1">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea id="comment" class="block mt-1 w-full form-control" type="text" name="comment" :value="old('comment')" autocomplete="result" >{{ $review->comment }}</textarea>
                            </div>

                            <!-- how to improve -->
                            <div class="mt-4">
                                <x-input-label for="improve" :value="__('How to improve')" />
                                <textarea id="improve" class="block mt-1 w-full form-control" type="text" name="improve" :value="old('improve')" autocomplete="result" >{{ $review->improve }}</textarea>
                            </div>

                            <!-- Comments to the author -->
                            <div class="mt-4">
                                <x-input-label for="comment_author" :value="__('Comments to the author')" />
                                <textarea id="comment_author" class="block mt-1 w-full form-control" type="text" name="comment_author" :value="old('comment_author')" autocomplete="result" >{{ $review->comment_author }}</textarea>
                            </div>
                        </div>
